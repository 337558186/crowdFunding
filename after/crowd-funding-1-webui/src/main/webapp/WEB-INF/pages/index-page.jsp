            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a> | </a></li>
                        <li><a href="admin/to/loginPage.html">管理员登录</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="box ui-draggable" id="mainBox">
                    ...
                    <div class="mBd" style="padding-top:10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="../../static/img/product-5.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="project.html">活性富氢净水直饮机</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="../../static/img/product-6.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="project.html">酷驰触控龙头，智享厨房黑科技</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="../../static/img/product-7.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="project.html">小熊猫鱼眼全景安防摄像机</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="../../static/img/product-8.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="project.html">一款精致的机械表</a>
                                        </h3>
                ...
                <div class="box ui-draggable" id="mainBox">
                    ...
                    <div class="mBd" style="padding-top:10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="../../static/img/product-9.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="project.html">活性富氢净水直饮机</a>
                                        </h3>
